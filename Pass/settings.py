...
SECRET_KEY = 'django-insecure-8m$7e0arn0v3zbzzh)m0^cl$-@e@bezlq^p6v5qys-5fbrrk^6'
...
MIGRATION_MODULES = {
    'pass_app': 'pass_app.migrations',
    'auth': 'django.contrib.auth.migrations',
    # Añade otras aplicaciones según sea necesario
}

JAZZMIN_SETTINGS = {
    # title of the window (Will default to current_admin_site.site_title if absent or None)
    "site_title": "Admin de paas",
    ...
    "welcome_sign": "Bienvenido al sitio administrativo de PAAS",
    #
    ...
    "topmenu_links": [
        ...
        # {"model": "main_app.ProyectoTerminados"},
        #
    ...
    "custom_links": {
        "pass_app": [{
            "name": "Mira los mensages",
            "url": "make_messages",
            "icon": "fas fa-comments",
            "permissions": ["pass_app.view_profile", "pass_app"]
        }]
    },
    #
